    ...
    return (
        ...
        <div className='flex flex-grow  bg-black p-1 px-2 text-xs border-4 border-yellow-300 
            ...
            <div className="flex flex-col h-full ">
                ...
                <h1 className="my-2 font-bold text-xs sm:text-xl text-center text-yellow-300">WINNER</h1>
                ...
                <table>
                    ...
                    <tbody>{winner[0] === 'nf' || winner.length === 0? <></>: rows}</tbody>
                </table>
                {winner[0] === 'nf'? <h1 className="text-white text-center">No Players Found</h1> : <></>}
                {winner.length === 0? <div className='text-white text-center text-2xl'><FontAwesomeIcon icon="fa-solid fa-spinner" spin /></div>  : <></>}
            </div>
        </div>
        </>
    );
